<template lang="">
    <!-- Desktop -->
    <div class="max-sm:flex-col w-[100%] h-[100vh] flex gap-3 bg-black font-sans">
        <div class="w-[70%] h-full">
            <img class="w-full h-full object-contain" :src="artist?.images?.[0]?.url" alt="">
        </div>

        <div class="w-[30%] h-full text-white font-sans">

            <div class="w-[100px] h-[100px] grid grid-cols-2 grid-rows-2 border-[1px] border-gray-400 gap-[2px] bg-gray-400">
